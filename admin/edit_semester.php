...
if(isset($_POST['update_btn'])){
    ...
    $message=$semester_name->updateSemesterName($_POST);
}

$edit_id = $_GET['id'];
require_once '../class/admin.php';
$edit_name = new admin();
$query_result=$edit_name->editSemesterName($edit_id);
$semester_info=mysqli_fetch_assoc($query_result);
            ...
            <div class="card card-body bg-info">
                <form action="" method="post">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Semester ID</strong></label>
                        <div class="col-sm-10">
                            <input type="text" name="semester_id" class="form-control" value="<?php echo $semester_info['semester_id'];?>" maxlength="11" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="semester_name" class="form-control" value="<?php echo $semester_info['semester_name'];?>" maxlength="11" required>
                            <input type="hidden" name="id" value="<?php echo $semester_info['semester_id']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="offset-md-2 col-sm-10">
                            <button type="submit" name="update_btn" class="btn btn-danger btn-block" >Update Semester</button>
                        </div>
                    </div>
                </form>
