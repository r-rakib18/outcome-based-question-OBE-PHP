...
if (isset($_GET['logout']))
{
    ...
    $course_offer_list = new admin();
    $query_result = $course_offer_list->CourseOfferList($_POST);
...
if (isset($_GET['delete'])){
    ...
    $delete_info->DeleteOfferName($delete);
}
            ...
            <div class="card card-body bg-dark">
                <div class="table-responsive">
                    <table class="table table-striped table-sm table-bordered" style="color: white" >
                        ...
                        <tbody>
                        <?php $i=1; foreach ($query_result as $offer_list) {?>
                            <tr>
                                <td><?php echo $i++?></td>
                                <td><?php echo $offer_list['semester_name'];?></td>
                                <td><?php echo $offer_list['course_code'];?></td>
                                <td><?php echo $offer_list['teacher_name'];?></td>
                                <td><?php echo $offer_list['pro_name'];?></td>
                                <td><?php echo $offer_list['intake'];?></td>
                                <td><?php echo $offer_list['section'];?></td>
                                <td>

                                        <a href="?delete=<?php echo $offer_list['offer_id']?>" class="btn btn-danger btn-sm">
