...
if (isset($_POST['program_btn'])){
    ...
    $message=$programe_name->ProgrameName($_POST);
                    ...
                    <div class="card card-body bg-info">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="program_name" class="form-control" style="text-transform: uppercase;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="offset-md-2 col-sm-10">
                                    <button type="submit" name="program_btn" class="btn btn-danger btn-block" >Save Program</button>
                                </div>
                            </div>
                        </form>
