...
if(isset($_POST['update_btn'])){
    ...
    $update_chapter = new admin();
    $message=$update_chapter->UpdateChapter($_POST);
}

$edit_id = $_GET['id'];
require_once '../class/admin.php';
$chapter_name=new admin();
$query_result=$chapter_name->EditChapter($edit_id);
$chapter_info=mysqli_fetch_assoc($query_result);
            ...
            <div class="card card-body bg-info">
                <form action="" method="post">
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Chapter No</strong></label>
                        <div class="col-sm-10">
                            <input type="text" name="chapter_no" value="<?php echo $chapter_info['chapter_no'];?>" class="form-control">

                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Chapter Name</strong></label>
                        <div class="col-sm-10">
                            <input type="text" name="chapter_name" value="<?php echo $chapter_info['chapter_title'];?>" class="form-control">
                            <input type="hidden" name="id" value="<?php echo $chapter_info['chapter_id'];?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="offset-md-2 col-sm-10">
                            <button type="submit" name="update_btn" class="btn btn-danger btn-block" >Update Chapter</button>
                        </div>
                    </div>
