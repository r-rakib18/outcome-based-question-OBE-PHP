...
$course_list=new admin();
$query_result=$course_list->CourseList();
...
if (isset($_GET['delete'])){
    ...
    $delete_info->DeleteCourseName($delete);
}
...
<div class="container">
    <div class="row">
        <div class="col-lg-8 offset-md-3" style="margin-top:100px;">
            <div class="card card-body bg-dark">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-sm table-bordered" style="color: white" >
                        ...
                        <tbody>
                        <?php $i=1; foreach ($query_result as $course_list) {?>
                            <tr>
                                <td><?php echo $i++?></td>
                                <td><?php echo $course_list['course_code'];?></td>
                                <td><?php echo $course_list['course_title'];?></td>
                                <td><?php echo $course_list['course_credit'];?></td>
                                <td>
                                    <a href="edit_course.php?id=<?php echo $course_list['course_id'];?>" class="btn btn-success btn-sm">
                                        <span><strong>Edit</strong></span>
                                    </a>
                                        <a href="?delete=<?php echo $course_list['course_id']?>" class="btn btn-danger btn-sm">
