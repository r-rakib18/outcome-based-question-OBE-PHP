...
if(isset($_POST['semester_btn'])){
    ...
    $message=$semester_name->Semester($_POST);
}

require_once '../class/admin.php';
$semester_name=new admin();
$query_result=$semester_name->semesterName();
...
if (isset($_GET['delete'])){
    ...
    $delete_info->deleteSemesterName($delete);
}
                    ...
                    <div class="card card-body bg-info">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="semester_name" class="form-control" maxlength="11" required style="text-transform: uppercase;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="offset-md-2 col-sm-10">
                                    <button type="submit" name="semester_btn" class="btn btn-danger btn-block" >Save Semester</button>
                                </div>
                            </div>
