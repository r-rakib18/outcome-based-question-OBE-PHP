                    ...
                    <div class="card card-body bg-info">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Exam Name</strong></label>
                                <div class="col-sm-10">
                                    <input type="text" name="exam_name" class="form-control" style="text-transform: uppercase;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2  col-form-label"><strong>Exam Time</strong></label>
                                <div class="col-sm-10">
                                    <div>
                                        <input type="number" name="exam_time" step="0.01" min="0" max="3" class="form-control">
                            ...
                            <div class="form-group row">
                                <div class="offset-md-2 col-sm-10">
                                    <button type="submit" name="exam_btn" class="btn btn-danger btn-block" >Save Exam</button>
                                </div>
                            </div>
                        </form>
