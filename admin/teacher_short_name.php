...
$user_short_list=new admin();
$query_result=$user_short_list->ShortName();
        ...
        <div class="col-lg-6 offset-md-4" style="margin-top:100px;">
            <form action="user_list.php" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="short_name" class="form-control">
                            <option disabled selected>--Select User Short Name--</option>

                            <?php foreach ($query_result as $value) {?>
                                <option  value="<?php echo $value['teacher_id'];?>"><?php echo $value['short_name'];?></option>
                            <?php } ?>
                ...
                <div class="form-group row">
                    <div class="offset-md-2 col-sm-10">
                        <button type="submit" name="see_user" class="btn btn-danger btn-block" >See User</button>
                    </div>
                </div>
            </form>
