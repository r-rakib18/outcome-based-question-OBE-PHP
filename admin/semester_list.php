            ...
            <div class="card card-body bg-dark">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-sm table-bordered" style="color: white" >
                        ...
                        <tbody>
                        <?php foreach ($query_result as $semester_name) {?>
                            <tr>
                                <td><?php echo $semester_name['semester_id']?></td>
                                <td><?php echo $semester_name['semester_name'];?></td>

                                <td>
                                    <a href="edit_semester.php?id=<?php echo $semester_name['semester_id'];?>" class="btn btn-success btn-sm">
                                        <span><strong>Edit</strong></span>
                                    </a>
                                        <a href="?delete=<?php echo $semester_name['semester_id']?>" class="btn btn-danger btn-sm">
