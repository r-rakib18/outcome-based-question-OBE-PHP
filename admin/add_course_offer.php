...
$courseOffer_list=new admin();
$semester_name=$courseOffer_list->semesterName();
$course_list=$courseOffer_list->CourseList();
$all_teacher_list=$courseOffer_list->AllTeacher();
$programme_list=$courseOffer_list->ProgrameNameList();


$message="";
if(isset($_POST['courseOffer_btn']))
{
    require_once '../class/admin.php';
    $insert_courseoffer=new admin();
    $message=$insert_courseoffer->CourseOfferInsert($_POST);
...
<div class="container-fluid">
    ...
    <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-md-2" style="margin-top: 20px; padding: 80px;">
                    <div class="card card-body bg-info">
                        <h5 class=" text-center text-danger"><?php echo $message;?></h5>
                        <form action="" method="post">
                            
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Semester Name</strong> </label>
                                <div class="col-sm-10">
                                    <select name="semester_name" class="form-control">
                                         <option disabled selected>--Select Semester Name--</option>
                                         
                                        <?php foreach ($semester_name as $value) {?>
                                        <option value="<?php echo $value['semester_id'];?>"><?php echo $value['semester_name'];?></option>
                                        <?php } ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="teacher_name" class="form-control">
                                        ...
                                        <?php foreach ($all_teacher_list as $value) {?>
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Intake</strong></label>
                                <div class="col-sm-10">
                                    <input type="number" name="intake" class="form-control" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Section</strong></label>
                                <div class="col-sm-10">
                                    <input type="number" name="section"  class="form-control" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="offset-md-2 col-sm-10">
                                    <button type="submit" name="courseOffer_btn" class="btn btn-danger btn-block" >Save Offer</button>
                                </div>
                            </div>
                        </form>
