...
if(isset($_POST['keyword_btn'])){
    ...
    $keyword=new admin();
    $message=$keyword->KeywordInsert($_POST);
}
                    ...
                    <div class="card card-body bg-info">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Keyword Name</strong></label>
                                <div class="col-sm-10">
                                    <input type="text" name="keyword_name" class="form-control" style="text-transform: uppercase;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="offset-md-2 col-sm-10">
                                    <button type="submit" name="keyword_btn" class="btn btn-danger btn-block" >Save Keyword</button>
                                </div>
                            </div>
                        </form>
