...
$programe_name=new admin();
$query_result=$programe_name->ProgrameNameList();
$message="";
if(isset($_POST['book_btn'])){
    require_once '../class/admin.php';
    $book_name=new admin();
    $message=$book_name->BookName($_POST);
}
                    ...
                    <div class="card card-body bg-info">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="book_name" class="form-control"style="text-transform: uppercase;" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Author</strong></label>
                                <div class="col-sm-10">
                                    <input type="text" name="author"  class="form-control" style="text-transform: uppercase;" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="offset-md-2 col-sm-10">
                                    <button type="submit" name="book_btn" class="btn btn-danger btn-block" >Save Book</button>
                                </div>
                            </div>
                        </form>
