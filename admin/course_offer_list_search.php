...
$query_result=$course_offer_list->TeacherNameByCourseOffer();
...
<div class="container">
    <div class="row">
        <div class="col-lg-6 offset-md-4" style="margin-top:60px;">
            ...
            <form action="course_offer_list.php" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="teacher_dept" class="form-control">
                            ...
                            <?php foreach ($query_result as $value) {?>
                                <option  value="<?php echo $value['teacher_dept'];?>"><?php echo $value['teacher_dept'];?></option>
                            <?php } ?>
                ...
                <div class="form-group row">
                    <div class="offset-md-2 col-sm-10">
                        <button type="submit" name="see_courseOffer" class="btn btn-danger btn-block" >See Book</button>
                    </div>
                </div>
            </form>
        </div>
