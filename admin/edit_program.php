...
if(isset($_POST['update_btn'])){
    ...
    $pro_name = new admin();
    $message=$pro_name->UpdateProName($_POST);
}

$edit_id = $_GET['id'];
require_once '../class/admin.php';
$pro_edit_name = new admin();
$query_result=$pro_edit_name->EditProgram($edit_id);
$pro_info=mysqli_fetch_assoc($query_result);
            ...
            <div class="card card-body bg-info">
                <form action="" method="post">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Program ID</strong></label>
                        <div class="col-sm-10">
                            <input type="text" name="pro_id" class="form-control" value="<?php echo $pro_info['pro_id'];?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="pro_name" class="form-control" value="<?php echo $pro_info['pro_name'];?>">
                            <input type="hidden" name="id" value="<?php echo $pro_info['pro_id']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="offset-md-2 col-sm-10">
                            <button type="submit" name="update_btn" class="btn btn-danger btn-block" >Update Program</button>
                        </div>
                    </div>
                </form>
