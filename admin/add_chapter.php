...
$book_name=new admin();
$query_result=$book_name->BookNameList();
$message="";
if(isset($_POST['chapter_btn']))
{
    require_once '../class/admin.php';
    $chapter_name=new admin();
    $message=$chapter_name->Chapter($_POST);
}
                    ...
                    <div class="card card-body bg-info">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="chapter_no" class="form-control" min="1">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Chapter Title</strong></label>
                                <div class="col-sm-10">
                                    <input type="text" name="chapter_title"  class="form-control" style="text-transform: uppercase;">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="offset-md-2 col-sm-10">
                                    <button type="submit" name="chapter_btn" class="btn btn-danger btn-block" >Save Chapter</button>
                                </div>
                            </div>
                        </form>
