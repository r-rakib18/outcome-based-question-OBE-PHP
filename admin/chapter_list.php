...
if (isset($_GET['logout']))
{
    ...
    $query_result = $chapter_name->ChapterList($_POST);
...
if (isset($_GET['delete'])){
    ...
    $delete_info->DeleteChapter($delete);
}
            ...
            <div class="card card-body bg-dark">
                <div class="table-responsive">
                    <table class="table table-striped table-sm table-bordered" style="color: white" >
                        ...
                        <tbody>
                        <?php foreach ($query_result as $chapter_title) {?>
                            <tr>
                                <td><?php echo $chapter_title['chapter_no'];?></td>
                                <td><?php echo $chapter_title['chapter_title'];?></td>
                                <td>
                                    <a href="edit_chapter.php?id=<?php echo $chapter_title['chapter_id'];?>" class="btn btn-success btn-sm">
                                        <span><strong>Edit</strong></span>
                                    </a>
                                        <a href="?delete=<?php echo $chapter_title['chapter_id'];?>" class="btn btn-danger btn-sm">
