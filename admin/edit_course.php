...
if(isset($_POST['update_btn'])){
    ...
    $message=$semester_name->UpdateCourseName($_POST);
}

$edit_id = $_GET['id'];
require_once '../class/admin.php';
$course_edit_name = new admin();
$query_result=$course_edit_name->EditCourse($edit_id);
$course_info=mysqli_fetch_assoc($query_result);
            ...
            <div class="card card-body bg-info">
                <form action="" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="course_code" class="form-control" value="<?php echo $course_info['course_code'];?>">
                            <input type="hidden" name="id" value="<?php echo $course_info['course_id']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Course Title</strong></label>
                        <div class="col-sm-10">
                            <input type="text" name="course_title" class="form-control" value="<?php echo $course_info['course_title'];?>" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="course_credit" class="form-control" value="<?php echo $course_info['course_credit'];?>" >

                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="offset-md-2 col-sm-10">
                            <button type="submit" name="update_btn" class="btn btn-danger btn-block" >Update Course</button>
                        </div>
                    </div>
                </form>
