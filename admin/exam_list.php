...
$exam_list=new admin();
$query_result = $exam_list->ExamList();

if (isset($_GET['delete'])){
    require_once '../class/admin.php';
    $delete_keyword=new admin();
    $delete=$_GET['delete'];
    $delete_keyword->DeleteExam($delete);
            ...
            <div class="card card-body bg-dark">
                <div class="table-responsive">
                    <table class="table table-striped table-sm table-bordered" style="color: white" >
                        ...
                        <tbody>
                        <?php $i=1; foreach ($query_result as $exam_list) {?>
                            <tr>
                                <td><?php echo $exam_list['exam_id']?></td>
                                <td><?php echo $exam_list['exam_name'];?></td>
                                <td><?php echo $exam_list['exam_time'];?></td>
                                <td>
                                    <a href="?delete=<?php echo $exam_list['exam_id']?>" class="btn btn-danger btn-sm">
